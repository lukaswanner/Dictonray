...
public class tui {
    ...
    private static void tuui() throws IOException {
        ...
        System.out.println("Alle Befehle: ");
        System.out.println("Befehl: create Sortierverfahren          ");
        System.out.println("Befehl: read[n] Dateiname                ");
        System.out.println("Befehl: p                                ");
        System.out.println("Befehl: s Key                            ");
        System.out.println("Befehl: i + Key Value                    ");
        System.out.println("Befehl: r + Key                          ");
        System.out.println("Befehl: exit                             ");
        while (true) {
            try {
                ...
                if (a[0].equals("create")) {
                    ...
                    } else if (a.length == 2 && a[1].contains("tree")) {
                        dict = new BinaryTreeDictionary<>();
                        System.out.println("verwenden nun BinaryTreeDictionary");
                    } else {
